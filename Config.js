...
globalThis.ACTIVITY_FEED_SHEET = globalThis.ACTIVITY_FEED_SHEET || 'Activity Feed';
globalThis.DASHBOARD_METRICS_SHEET = globalThis.DASHBOARD_METRICS_SHEET || 'Dashboard Metrics';
globalThis.CLIENTS_SHEET = globalThis.CLIENTS_SHEET || 'Clients';

globalThis.CLIENT_COLUMNS = globalThis.CLIENT_COLUMNS || [
  'Client Name',
  'Contact',
  'Email',
  'Phone',
...
globalThis.PIPELINE_STAGES = globalThis.PIPELINE_STAGES || [
  'Lead Found',
  'Audit Complete',
  'Draft Created',
  'Discovery Scheduled',
...
globalThis.PIPELINE_STAGE_COLORS = globalThis.PIPELINE_STAGE_COLORS || {
  'Lead Found': '#d9d9d9',
...
globalThis.DEMO_COMPANY_NAMES = globalThis.DEMO_COMPANY_NAMES || [
...
globalThis.MASTER_PROSPECT_STANDARD_ORDER_AFTER_WEBSITE = globalThis.MASTER_PROSPECT_STANDARD_ORDER_AFTER_WEBSITE || [
  'City',
  'State',
  'Industry',
  'Source'
...
globalThis.SMART_AUDIT_FINDINGS_LIBRARY = globalThis.SMART_AUDIT_FINDINGS_LIBRARY || [
  {
    key: 'missingWebsite',
