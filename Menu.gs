...
function onOpen(e) {
  ...
  const pipelineMenu = ui.createMenu('Pipeline')
    ...
    .addSeparator()
    .addItem('Confirm Executive Brief Sent', 'confirmExecutiveSnapshotSent')
    .addItem('Confirm Digital Business Assessment', 'confirmAssessmentPresented')
  ...
  if (developerModeEnabled) {
    const developmentMenu = ui.createMenu('Development')
      ...
      .addSeparator()
      .addItem('Run Website Inspection', 'runRealWebsiteAudit')
