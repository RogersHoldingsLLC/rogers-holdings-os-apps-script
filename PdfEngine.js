  ...
  const html = buildBrandedPdfHtml_({
    ...
    bodyHtml: [
      ...
      brandedPdfSectionHtml_('Executive Summary', executiveSummaryCardsHtml_([
        ['Score', displayAuditScoreForPdf_(prospect, consultingFindings), scoreStatusClass_(prospect.auditScore)],
...
function buildProposalPdfBlob_(prospect, proposal) {
  ...
  const html = buildBrandedPdfHtml_({
    ...
    bodyHtml: [
      ...
      brandedPdfSectionHtml_('Deliverables + Roadmap', deliverableCardsHtml_(recommendedPackage.deliverables) + projectRoadmapHtml_()),
      brandedPdfSectionHtml_('Why This Matters + Approval', whyRogersHoldingsHtml_() + acceptancePageHtml_(prospect, recommendedPackage))
    ].join('')
  });
    ...
    <html>
      ...
      <body>
        <div class="doc-shell">
          ...
          <div class="footer">Rogers Holdings LLC &nbsp; | &nbsp; ${escapeHtml_(document.title || '')} &nbsp; | &nbsp; Confidential Business Review</div>
          ${document.bodyHtml}
        </div>
      </body>
    </html>
